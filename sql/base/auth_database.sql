...
MySQL - 5.7.33-log : Database - auth547
*********************************************************************
*/
...
insert  into `realmlist`(`id`,`name`,`address`,`port`,`icon`,`flag`,`timezone`,`allowedSecurityLevel`,`population`,`gamebuild`,`online`) values 
(1,'WarcraftLifeMoP','127.0.0.1',8085,0,0,1,0,0,18414,0);
